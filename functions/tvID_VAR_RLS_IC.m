function [A,Su,phi_w]=tvID_VAR_RLS_IC(XM,p,c,A_i,Su_i)
...
% output:
% A    --> estimate of AR parmeters (M x Mp x N) N.B. for notation purposes
% A vector in the main paper is reported as Mp x M x N
...
%% References : 
% [1] - Y. Antonacci et al. (2024) - Time-varying information measures: 
